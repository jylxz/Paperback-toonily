  ...
  return (function () {
  ...
  })()(
    {
      ...
      6: [
        function (require, module, exports) {
          ...
          (function (SourceIntents) {
            SourceIntents[(SourceIntents["MANGA_CHAPTERS"] = 1)] =
              "MANGA_CHAPTERS";
            SourceIntents[(SourceIntents["MANGA_TRACKING"] = 2)] =
              "MANGA_TRACKING";
            SourceIntents[(SourceIntents["HOMEPAGE_SECTIONS"] = 4)] =
              "HOMEPAGE_SECTIONS";
            SourceIntents[(SourceIntents["COLLECTION_MANAGEMENT"] = 8)] =
              "COLLECTION_MANAGEMENT";
            SourceIntents[(SourceIntents["CLOUDFLARE_BYPASS_REQUIRED"] = 16)] =
              "CLOUDFLARE_BYPASS_REQUIRED";
            SourceIntents[(SourceIntents["SETTINGS_UI"] = 32)] = "SETTINGS_UI";
          })(
            (SourceIntents =
              exports.SourceIntents || (exports.SourceIntents = {}))
          );
          /**
      ...
      15: [
        ...
        {
          "./ChapterProviding": 8,
          "./CloudflareBypassRequestProviding": 9,
          "./HomePageSectionsProviding": 10,
          "./MangaProgressProviding": 11,
          "./MangaProviding": 12,
          "./RequestManagerProviding": 13,
          "./SearchResultsProviding": 14,
        },
      ],
      16: [
        function (require, module, exports) {
      ...
      60: [
        function (require, module, exports) {
          ...
          __exportStar(
            require("./DynamicUI/Rows/Exports/DUIInputField"),
            exports
          );
          __exportStar(require("./DynamicUI/Rows/Exports/DUILabel"), exports);
          __exportStar(require("./DynamicUI/Rows/Exports/DUILink"), exports);
          __exportStar(
            require("./DynamicUI/Rows/Exports/DUIMultilineLabel"),
            exports
          );
          __exportStar(
            require("./DynamicUI/Rows/Exports/DUINavigationButton"),
            exports
          );
          __exportStar(
            require("./DynamicUI/Rows/Exports/DUIOAuthButton"),
            exports
          );
          __exportStar(
            require("./DynamicUI/Rows/Exports/DUISecureInputField"),
            exports
          );
          ...
          __exportStar(
            require("./Exports/TrackedMangaChapterReadAction"),
            exports
          );
          __exportStar(require("./Exports/TrackerActionQueue"), exports);
        },
        {
          "./DynamicUI/Exports/DUIBinding": 17,
          "./DynamicUI/Exports/DUIForm": 18,
          "./DynamicUI/Exports/DUIFormRow": 19,
          "./DynamicUI/Exports/DUISection": 20,
          "./DynamicUI/Rows/Exports/DUIButton": 21,
          "./DynamicUI/Rows/Exports/DUIHeader": 22,
          "./DynamicUI/Rows/Exports/DUIInputField": 23,
          "./DynamicUI/Rows/Exports/DUILabel": 24,
          "./DynamicUI/Rows/Exports/DUILink": 25,
          "./DynamicUI/Rows/Exports/DUIMultilineLabel": 26,
          "./DynamicUI/Rows/Exports/DUINavigationButton": 27,
          "./DynamicUI/Rows/Exports/DUIOAuthButton": 28,
          "./DynamicUI/Rows/Exports/DUISecureInputField": 29,
          "./DynamicUI/Rows/Exports/DUISelect": 30,
          "./DynamicUI/Rows/Exports/DUIStepper": 31,
          "./DynamicUI/Rows/Exports/DUISwitch": 32,
          "./Exports/Chapter": 33,
          "./Exports/ChapterDetails": 34,
          "./Exports/Cookie": 35,
          "./Exports/HomeSection": 36,
          "./Exports/IconText": 37,
          "./Exports/MangaInfo": 38,
          "./Exports/MangaProgress": 39,
          "./Exports/MangaUpdates": 40,
          "./Exports/PBCanvas": 41,
          "./Exports/PBImage": 42,
          "./Exports/PagedResults": 43,
          "./Exports/PartialSourceManga": 44,
          "./Exports/RawData": 45,
          "./Exports/Request": 46,
          "./Exports/RequestManager": 47,
          "./Exports/Response": 48,
          "./Exports/SearchField": 49,
          "./Exports/SearchRequest": 50,
          "./Exports/SecureStateManager": 51,
          "./Exports/SourceCookieStore": 52,
          "./Exports/SourceInterceptor": 53,
          "./Exports/SourceManga": 54,
          "./Exports/SourceStateManager": 55,
          "./Exports/Tag": 56,
          "./Exports/TagSection": 57,
          "./Exports/TrackedMangaChapterReadAction": 58,
          "./Exports/TrackerActionQueue": 59,
        },
      ],
      61: [
        function (require, module, exports) {
      ...
      62: [
        function (require, module, exports) {
          ...
          var decode_data_html_js_1 = __importDefault(
            require("./generated/decode-data-html.js")
          );
          exports.htmlDecodeTree = decode_data_html_js_1.default;
          var decode_data_xml_js_1 = __importDefault(
            require("./generated/decode-data-xml.js")
          );
          exports.xmlDecodeTree = decode_data_xml_js_1.default;
          var decode_codepoint_js_1 = __importStar(
            require("./decode_codepoint.js")
          );
          ...
          var EntityDecoder = /** @class */ (function () {
             ...
             * @returns The number of characters that were consumed, or -1 if the entity is incomplete.
             */
            EntityDecoder.prototype.stateNumericDecimal = function (
              str,
              offset
            ) {
              var startIdx = offset;
        ...
        {
          "./decode_codepoint.js": 63,
          "./generated/decode-data-html.js": 66,
          "./generated/decode-data-xml.js": 67,
        },
      ],
      63: [
        function (require, module, exports) {
      ...
      64: [
        function (require, module, exports) {
          ...
          var encode_html_js_1 = __importDefault(
            require("./generated/encode-html.js")
          );
        ...
        { "./escape.js": 65, "./generated/encode-html.js": 68 },
      ],
      65: [
        function (require, module, exports) {
          "use strict";
    ...
    .map(function (c) { return c.charCodeAt(0); })
      ...
      69: [
        ...
        { "./decode.js": 62, "./encode.js": 64, "./escape.js": 65 },
      ],
      70: [
        function (require, module, exports) {
          "use strict";
          ...
          class Madara {
                        ...
                        rows: async () => [
                          App.createDUISwitch({
                            ...
                            value: App.createDUIBinding({
                              get: async () =>
                                (await stateManager.retrieve("HQthumb")) ??
                                false,
                              set: async (newValue) =>
            ...
            async getChapters(mangaId) {
              ...
              if (this.alternativeChapterAjaxEndpoint) {
                if (this.usePostIds) {
                  const slugData = await this.convertPostIdToSlug(
                    Number(mangaId)
                  );
            ...
            async slugToPostId(slug, path) {
              if ((await this.stateManager.retrieve(slug)) == null) {
                ...
                const existingMappedSlug = await this.stateManager.retrieve(
                  postId
                );
            ...
            async convertSlugToPostId(slug, path) {
              ...
              const headResponse = await this.requestManager.schedule(
                headRequest,
                1
              );
              let postId;
              const postIdRegex =
                headResponse?.headers["Link"]?.match(/\?p=(\d+)/);
              ...
              if (isNaN(postId)) {
                postId = Number(
                  $("a.wp-manga-action-button").attr("data-post")
                );
              }
        ...
        { "./MadaraHelper": 71, "./MadaraParser": 72, "@paperback/types": 61 },
      ],
      71: [
        function (require, module, exports) {
          "use strict";
          ...
          class Parser {
            constructor() {
              this.parseDate = (date) => {
                ...
                if (
                  date.includes("LESS THAN AN HOUR") ||
                  date.includes("JUST NOW")
                ) {
                  time = new Date(Date.now());
            ...
            async parseMangaDetails($, mangaId, source) {
              ...
              const author = this.decodeHTMLEntity(
                $("div.author-content").first().text().replace("\\n", "").trim()
              ).replace("Updating", "");
              const artist = this.decodeHTMLEntity(
              ...
              const description = this.decodeHTMLEntity(
                ...
                .replace("Show more", "")
                .trim();
              const rating = Number(this.decodeHTMLEntity($("div.post-total-rating"))
                .last()
                .text()
                .trim());
      ...
      73: [
        function (require, module, exports) {
          ...
          exports.ToonilyInfo = {
            ...
            intents:
              types_1.SourceIntents.MANGA_CHAPTERS |
